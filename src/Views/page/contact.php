...
<div class="container-fluid px-4 py-5">
    ...
    <div class="bg-primary bg-gradient rounded shadow-sm mb-4 p-4 text-white">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h3 mb-2">Liên hệ với chúng tôi</h1>
                <p class="opacity-75">Thông tin liên hệ Trường Đại Học Phương Đông tại Trung Kính</p>
            </div>
            <div class="d-none d-md-block">
                <i class="fas fa-phone-volume display-4 text-white opacity-25"></i>
            </div>
        </div>
    </div>
