...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-tachometer-alt me-2"></i> Bảng Điều Khiển Sinh Viên</h1>
            <p class="text-muted">Quản lý lịch đặt phòng và theo dõi hoạt động của bạn</p>
        </div>
        <div>
