...
<div class="container-fluid mt-4">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-users me-2"></i> Quản lý người dùng</h1>
            <p class="text-muted">Quản lý tài khoản và quyền truy cập trong hệ thống</p>
        </div>
        <a href="/pdu_pms_project/public/admin/add_user" class="d-none d-sm-inline-block btn btn-success shadow-sm">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?= count(array_filter($data['users'] ?? [], function($user) { return $user['role'] === 'admin'; })) ?>
                            </div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                Giảng viên</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?= count(array_filter($data['users'] ?? [], function($user) { return $user['role'] === 'teacher'; })) ?>
                            </div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Sinh viên</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?= count(array_filter($data['users'] ?? [], function($user) { return $user['role'] === 'student'; })) ?>
                            </div>
                        </div>
                        <div class="col-auto">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="/pdu_pms_project/public/admin/delete_user?id=<?= $user['id'] ?? '' ?>" 
                                               ...
                                               onclick="return confirm('Bạn có chắc muốn xóa người dùng <?= htmlspecialchars($user['username'] ?? '') ?>?')">
