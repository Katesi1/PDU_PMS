...
<div class="container-fluid mt-4">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-plus-circle me-2"></i> Thêm phòng mới</h1>
            <p class="text-muted">Thêm phòng học mới vào hệ thống quản lý</p>
        </div>
        <div>
                ...
                <div class="card-body">
                    <form method="POST" action="" id="addRoomForm">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control preview-trigger" id="location" name="location" placeholder="Vị trí phòng (tòa nhà, tầng...)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="features" class="form-label fw-bold">Thiết bị/Tính năng</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text"><i class="fas fa-tv"></i></span>
                                    <input type="text" class="form-control preview-trigger" id="features" name="features" placeholder="VD: Máy chiếu, Âm thanh...">
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="preview-room-details p-3 border rounded">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-6" id="previewRoomType">---</div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            <div class="col-6 text-muted">Vị trí:</div>
                            <div class="col-6" id="previewLocation">---</div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            <div class="col-6 text-muted">Thiết bị:</div>
                            <div class="col-6" id="previewFeatures">---</div>
                        </div>
                        <div class="mt-3">
            ...
            <div class="card shadow mb-4 info-card">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <div class="info-list">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    Mỗi phòng phải thuộc một loại phòng.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="action-buttons">
                        ...
                        <a href="/pdu_pms_project/public/admin/manage_room_types" class="btn btn-info btn-action">
                            <i class="fas fa-layer-group me-2"></i> Quản lý loại phòng
                        </a>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#addRoomForm').submit(function(event) {
            ...
            if ($('#room_type_id').val() === null) {
                showValidationError($('#room_type_id'), 'Vui lòng chọn loại phòng');
                isValid = false;
            }
        ...
        function updateRoomPreview() {
            ...
            var roomTypeName = roomTypeSelect.find('option:selected').text();
            if (roomTypeName === '-- Chọn loại phòng --') roomTypeName = '---';
