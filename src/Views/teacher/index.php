...
<div class="container-fluid mt-4">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-tachometer-alt me-2"></i> Bảng Điều Khiển</h1>
            <p class="text-muted">Quản lý lịch đặt phòng và theo dõi trạng thái phòng học</p>
        </div>
    </div>
