...
#### Quản lý loại phòng
- Truy cập đường dẫn: `/admin/manage_room_types`
- Chức năng:
  - Xem danh sách các loại phòng và số lượng phòng thuộc từng loại
...
## 6. Quản lý loại phòng (dành cho quản trị viên)

1. Truy cập: `/admin/manage_room_types`
2. Xem danh sách loại phòng hiện có và số lượng phòng
3. Thêm loại phòng mới:
   - Điền tên và mô tả loại phòng
   - Nhấn "Thêm loại phòng"
4. Sửa loại phòng: nhấn vào nút "Sửa" của loại phòng cần chỉnh sửa
5. Xóa loại phòng: chỉ có thể xóa loại phòng chưa có phòng nào thuộc loại đó
